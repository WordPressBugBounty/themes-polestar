			...
			if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) :
				...
				paginate_comments_links(
					apply_filters(
						...
						array(
							'prev_text' => is_rtl() ? '<span class="icon-long-arrow-right"></span>' : '<span class="icon-long-arrow-left"></span>',
							'next_text' => is_rtl() ? '<span class="icon-long-arrow-left"></span>' : '<span class="icon-long-arrow-right"></span>',
							'type'      => 'list',
						)
					)
				);
